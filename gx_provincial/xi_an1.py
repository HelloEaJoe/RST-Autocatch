            ...
            if red_big_ball is True:
                ...
                if red_ball_area <= 0.8:
                    ...
                    run_pwm_function(2, int(depth_pid.calculate(60, depth1, 1495)),
                                     int(yaw_pid.calculate(robot_yaw, last_robot_yaw, 1495)), 1550, 1500)
                ...
                if door_now == True:
                    ...
                    if rounds_for_door == 1:
                        ...
                        if door_area <= 0.8:
                            ...
                            run_pwm_function(1, pwm1, pwm2, 1600, 1500)
                            rounds_for_door == 0
