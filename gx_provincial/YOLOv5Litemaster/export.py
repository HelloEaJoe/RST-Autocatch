...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default=r"D:\Luke\water\robocup\xian_auto\gx_provincial\YOLOv5Litemaster\weights\best_1.pt", help='weights path')  # from yolov5/models/
